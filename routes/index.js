...
router.get('/api/catalogue', function(req, res, next) {
	...
	var addUser = {
		uri: '/api/addUser',
		method: 'POST',
		requiredParams: 'email, name, lease_budget, grade',
	...
	var updateUser = {
		uri: '/api/updateUser',
		method: 'POST',
		requiredParams: 'email and atleast one other params name/lease_budget/grade',
...
router.post('/api/addUser', function(req, res, next) {
	if(!req.body.email || !req.body.name || !req.body.lease_budget) {
...
router.post('/api/updateUser', function(req, res, next) {
	if(!req.body.email || (!req.body.name && !req.body.lease_budget && !req.body.grade)) {
		console.log(req.body);
...
router.post('/api/addLeaseRequest', function(req, res, next) {
...
router.get('/api/getLeaseRequest', function(req, res, next) {
	if(!req.query.userEmail) {
		console.log(req.body);
